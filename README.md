...
Sujet Groupe #04 — Objectif : accès humain via Boundary, secrets dynamiques via Vault, identité workload via SPIRE. Tout provisionné par Terraform + Packer + Ansible, validé par une pipeline GitHub Actions.
...
make demo-status     # État global Vault
```
